      ...
      <section className="py-20 bg-[#3061f2]">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="grid md:grid-cols-3 sm:grid-cols-2 gap-8 text-[#F0F9FF]">
            {[
              { name: "Fitri Jayitri I.S", role: "Pimpinan Proyek dan peneliti Strategis", img: "/profilesaibah.png" },
              { name: "Kalimah Wasis L.,S.IP.,M.SC.", role: "Pengawas", img: "/profilebukal.png" },
              { name: "Ahmad Idris", role: "Sekretaris dan Peneliti Admin", img: "/profileidris.png" },
              { name: "Aveny Raisa M", role: "Media kreatif dan Penulis Konten", img: "/profileaveny.png" },
              { name: "Zaid Sanjaya", role: "Pengembang Platform", img: "/profilezaid.png" },
              { name: "Ahmad Robiy'i", role: "UI/UX Designer", img: "/profileroby.png" },
            ].map((person, i) => (
